...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        R_chart3 = dcc.Graph(
            figure=px.pie(exp_rec,
                ...
                names="Vehicle_Type",
                title="Total expenditure per vehicle type"
        )
        )

# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unemploy_data = recession_data.groupby(["Vehicle_Type","unemployment_rate"])[["Automobile_Sales"]].sum().reset_index()
        R_chart4 = dcc.Graph(
            figure=px.bar(
                unemploy_data,
                x='Vehicle_Type',
...
#TASK 2.6: Returning the graphs for displaying Yearly data
        return [
                ...
                html.Div(children="Y_chart2")],style={'display':"flex"}),
                html.Div(className='chart-item', children=[html.Div(children="Y_chart3"),
                html.Div(children="Y_chart4")],style={'display':'flex'})
                ]
